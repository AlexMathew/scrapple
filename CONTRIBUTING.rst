...
Scrapple could always use more documentation, whether as part of the
official Scrapple docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, and 3.4, and for PyPy. Check
   https://travis-ci.org/scrappleapp/scrapple/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_scrapple
