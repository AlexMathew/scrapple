...
The Element type [9] is a data object that can contain tree-like data structures. 

The ElementTree wrapper [9] type adds code to load web pages as trees of Element objects. 
